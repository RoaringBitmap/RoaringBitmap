...
public final class SpeedyRoaringBitmap implements Cloneable, Serializable {
	 ...
	 */
        ...
        public static SpeedyRoaringBitmap and(final SpeedyRoaringBitmap x1,
                ...
                // final SpeedyRoaringBitmap answer = new
                // SpeedyRoaringBitmap(x1.getNbNodes()>=x2.getNbNodes()?x1.getNbNodes()
                // :x2.getNbNodes());
                ...
                /*
                 * This could be optimized quite a bit when one bitmap is much
        ...
        public void inPlaceAND(final SpeedyRoaringBitmap x2) {
                 ...
                 */
                int pos1 = 0, pos2 = 0;
                int length1 = this.getNbNodes(), length2 = x2.getNbNodes();
                ...
                main: if (pos1 < length1 && pos2 < length2) {
                        ...
                        do {
                                if (s1 < s2) {
                                        ...
                                        Container C = Util.and(this.get(s1),
                                                x2.get(s2));
                                        if (C.getCardinality() > 0)
        ...
        public static SpeedyRoaringBitmap or(final SpeedyRoaringBitmap x1,
                final SpeedyRoaringBitmap x2) {
                // int desiredcapacity =
                // x1.getNbNodes()+x2.getNbNodes()>65536?x1.getNbNodes()+x2.getNbNodes():65536;
                // final SpeedyRoaringBitmap answer = new
                // SpeedyRoaringBitmap(desiredcapacity);
                final SpeedyRoaringBitmap answer = new SpeedyRoaringBitmap();
                int pos1 = 0, pos2 = 0;
                int length1 = x1.highlowcontainer.getnbKeys(), length2 = x2.highlowcontainer
                        .getnbKeys();
        ...
        public boolean contains(final int x) {
                 ...
                 * This could translate into *two* binary searches! if
                 * (highlowcontainer.ContainsKey(hb)) { final Container C =
                 * highlowcontainer.get(hb); return C.contains(Util.lowbits(x));
                 * } return false;
                 */
        }
        ...
        /**
         * A RoaringBitmap is made of several container. The containers can be
         * reused if the RoaringBitmap object is going to be discarded. Note
         * that it is unsafe to keep accessing the RoaringBitmap object after
         * this call.
         */
