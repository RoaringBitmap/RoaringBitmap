...
/**
 * Various tests on Container and its subclasses,
...
public class TestContainer {
		...
		// bdry cases
		Container c = Container.rangeOfOnes(1,ArrayContainer.DEFAULTMAXSIZE);
		assertTrue( c instanceof ArrayContainer);
	}

        @Test
        public void rangeOfOnesTest4() {
		Container c = Container.rangeOfOnes(1,ArrayContainer.DEFAULTMAXSIZE+1);
		assertTrue( c instanceof BitmapContainer);
	}
	...
	public void inotTest5() {
		...
		content[0]=0; content[1]=2; content[2]=4;content[3]=6; content[4]=8;
	...
	public void inotTest6() {
		...
		// Bitmap container, range is partial and in one word, result stays bitmap
		short []content = new short[32768-5];
		content[0]=0; content[1]=2; content[2]=4;content[3]=6; content[4]=8;
		for (int i=10; i <= 32767; ++i)
			content[i-10+5] = (short) i;
	...
	public void notTest9() {
		...
		// Bitmap container, range is partial on the upper end, not single word
		short []content = new short[32768-5];
		content[0]=0; content[1]=2; content[2]=4;content[3]=6; content[4]=8;
		for (int i=10; i <= 32767; ++i)
			content[i-10+5] = (short) i;
	...
	public void inotTest10() {
		...
		content[0]=0; content[1]=2; content[2]=4;
		Container c = makeContainer(content);
		Container c1 = c.inot(65190,65200);
		assertTrue( c1 instanceof ArrayContainer);
		assertEquals(14, c1.getCardinality());
		assertTrue(checkContent(c1,new short [] {0,2,4,(short) 65190,
							 (short) 65191,
							 (short) 65192,
							 (short) 65193,
							 (short) 65194,
