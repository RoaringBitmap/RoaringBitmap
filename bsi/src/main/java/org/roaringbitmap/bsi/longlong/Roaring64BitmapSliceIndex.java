...
public class Roaring64BitmapSliceIndex {
    ...
    /**
     * NewBSI constructs a new BSI. Min/Max values are optional. If set to 0 then the underlying BSI
    ...
    /**
     * merge will merge 2 bsi into current merge API was designed for distributed computing note:
     * current and other bsi has no intersection
     *
    ...
    /**
     * BSI Compare using single thread this Function compose algorithm from O'Neil and Owen Kaser
