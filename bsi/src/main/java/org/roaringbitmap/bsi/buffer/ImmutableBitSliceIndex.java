...
public class ImmutableBitSliceIndex extends BitSliceIndexBase implements BitmapSliceIndex {
    ...
    /**
     * constructs a BSI use slice and ebM notes: the max size of BSI might be: 33 * 120MB( 1 Billion
     * cardinality) = 3960MB which might lead to OOM. so don't use this function if you have no idea
     * of the mechanism you'd better split your data and make every shard suitable for memory.
     *
     * @param bA
     * @param ebM
     * @param maxValue
    ...
    /**
     * constructs a BSI from byteBuffer notes: the max size of BSI might be: 33 * 120MB( 1 Billion
     * cardinality) = 3960MB which might lead to OOM. so don't use this function if you have no idea
     * of the mechanism you'd better split your data and make every shard suitable for memory.
     *
     * @param buffer
