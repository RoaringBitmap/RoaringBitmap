...
public class MutableBitSliceIndex extends BitSliceIndexBase implements BitmapSliceIndex {
    ...
    /**
     * construct a new MutableBitSliceIndex. Min/Max values are optional. If set to 0 then the
     * underlying BSI will be automatically sized.
     */
     ...
     * current and other bsi have no intersection
     */
    public void merge(MutableBitSliceIndex otherBsi) {
        ...
        for (int i = 0; i < bitDepth; i++) {
            ...
            MutableRoaringBitmap other =
                    i < otherBsi.bA.length
                            ? otherBsi.getMutableSlice(i)
