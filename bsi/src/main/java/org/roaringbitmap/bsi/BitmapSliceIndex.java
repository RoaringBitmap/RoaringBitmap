 ...
 * 1. if column c1 is string, we can encode c1 using dictionary. By bsi, we can only use 33 bit slice
 * express 2^32 cardinality dim.
 * 2. if column c2 is int32(that is 4Byte), for 1_000_000 rows, the size of c2 is more than 3.81MB. however,
