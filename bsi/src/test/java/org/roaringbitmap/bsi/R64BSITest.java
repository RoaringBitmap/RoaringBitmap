...
public class R64BSITest {
    ...
    public void testIssue753() throws IOException {
        ...
        Assertions.assertEquals(
                bsi.compare(BitmapSliceIndex.Operation.RANGE, -4, 56, null).getLongCardinality(),
                56);
        Assertions.assertEquals(
                bsi.compare(BitmapSliceIndex.Operation.RANGE, -4, 129, null).getLongCardinality(),
                99);
        Assertions.assertEquals(
                bsi.compare(BitmapSliceIndex.Operation.RANGE, -4, 200, null).getLongCardinality(),
                99);
        Assertions.assertEquals(
                bsi.compare(BitmapSliceIndex.Operation.RANGE, -4, 20000, null).getLongCardinality(),
                99);
        Assertions.assertEquals(
                bsi.compare(BitmapSliceIndex.Operation.RANGE, -4, -129, null).getLongCardinality(),
                0);
        Assertions.assertEquals(
                bsi.compare(BitmapSliceIndex.Operation.RANGE, -4, -2, null).getLongCardinality(),
                0);
        ...
        Assertions.assertEquals(
                bsi.compare(BitmapSliceIndex.Operation.RANGE, -129, -14, null).getLongCardinality(),
                0);
        Assertions.assertEquals(
                bsi.compare(BitmapSliceIndex.Operation.RANGE, 129, 2000, null).getLongCardinality(),
                0);
    }
