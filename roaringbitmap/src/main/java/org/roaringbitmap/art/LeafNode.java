...
public class LeafNode extends Node implements ContainerHolder {
   ...
   * @param container the corresponding container
   */
  public LeafNode(byte[] key, Container container) {
    super();
   ...
   * @param container the corresponding container
   */
  public LeafNode(long key, Container container) {
    super();
  ...
  public boolean equals(Object obj) {
    ...
    return this.keyHigh == other.keyHigh &&
        this.keyLow == other.keyLow &&
  ...
  public static LeafNode deserializeBody(DataInput dataInput) throws IOException {
    ...
    return new LeafNode(key, container);
  }

  public static LeafNode deserializeBody(ByteBuffer byteBuffer) throws IOException {
