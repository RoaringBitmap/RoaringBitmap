...
for ds in census1881.csv census-income.csv wikileaks-noquotes.csv uscensus2000.csv weather_sept_85.csv ; do
    java -cp ~/lemur-git/RoaringBitmap/target/RoaringBitmap-0.0.1-SNAPSHOT.jar:$CLASSPATH -javaagent:./lib/SizeOf.jar org.roaringbitmap.experiments.BenchmarkReal real-roaring-datasets $ds $N_EXPER
done
