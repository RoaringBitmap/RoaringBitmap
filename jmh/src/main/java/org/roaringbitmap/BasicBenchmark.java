...
public class BasicBenchmark {
   ...
   public int bigunion_immutable(ImmutableState state) {
      ...
      for (int k = 1, i = 0; k < state.N; k += 10, i++) {
         MutableRoaringBitmap bitmapor = BufferFastAggregation.horizontal_or(state.ors_immutable.get(i));
         bogus += bitmapor.getCardinality();
      }
   ...
   public static class ImmutableState {
      ...
      private ImmutableRoaringBitmap convertToMappedBitmap(MutableRoaringBitmap orig) throws IOException {
