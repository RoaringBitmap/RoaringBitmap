...
public class AndNotBenchmark {
   ...
   public int andNotSmallBitmap(BenchmarkState benchmarkState) {
       return benchmarkState.rc1.andNot(benchmarkState.bc1).getCardinality();
   }

   @Benchmark
   public int andNotBigBitmap(BenchmarkState benchmarkState) {
       return benchmarkState.rc2.andNot(benchmarkState.bc1).getCardinality();
   }

   @Benchmark
   public int andNotSmallBitmapold(BenchmarkState benchmarkState) {
       return benchmarkState.rc1.andNotold(benchmarkState.bc1).getCardinality();
   }

   @Benchmark
   public int andNotBigBitmapold(BenchmarkState benchmarkState) {
       return benchmarkState.rc2.andNotold(benchmarkState.bc1).getCardinality();
   }
