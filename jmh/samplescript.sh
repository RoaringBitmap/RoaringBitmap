./run.sh org.roaringbitmap.runcontainer.MappedRunContainerRealDataBenchmarkWideOr > mwideorlog.txt
...
./run.sh org.roaringbitmap.runcontainer.RunContainerRealDataBenchmarkWideOr > wideorlog.txt
